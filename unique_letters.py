...
def unique_letters_profanity(comment): 
    unique_letters_profanity_logger = logger('unique_letters_profanity')
    ...
    for word in [word for word in comment.split(' ')]: #iterating through each word in original comment
        ...
        try:
            ...
            unique_letters_profanity_logger.log_error(e)
            new_word = ' '
    ...
    for word in range(len(profane_return)):        #iterating through starred comment using unique words
        try:
            ...
            unique_letters_profanity_logger.log_error('Error in {profane_return[word]}:{e}')
